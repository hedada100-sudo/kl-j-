...
// ============================================================
//  ৭. USER: DEPOSIT (FIXED WITH DEBUG LOGS)
// ============================================================
app.post('/api/user/deposit', async (req, res) => {
    ...
    try {
        ...
        await newReq.save();
        console.log('✅ Deposit request saved with ID:', newReq._id);
...
// ============================================================
//  ৮. USER: WITHDRAW (FIXED WITH DEBUG LOGS)
// ============================================================
app.post('/api/user/withdraw', async (req, res) => {
    ...
    try {
        ...
        await newReq.save();
        console.log('✅ Withdraw request saved with ID:', newReq._id);
...
// ============================================================
//  ১১. SYSTEM CONFIG (Winning Percentage, Firebase, FAQ)
// ============================================================
...
app.get('/api/health', (req, res) => {
    res.json({
        ...
        users: mongoose.connection.readyState === 1 ? 'connected' : 'disconnected'
    });
});
